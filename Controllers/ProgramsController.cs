...
namespace WebApplication1.Controllers
{
    public class ProgramsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] DomainModel.Program program)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] DomainModel.Program program)
        {
            if (id != program.Id)
            {
                return NotFound();
